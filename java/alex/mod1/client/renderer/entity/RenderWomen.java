package alex.mod1.client.renderer.entity;
...
{
    private static final ResourceLocation DEFAULT_RES_LOC = new ResourceLocation(Reference.MODID + ":textures/models/entity/women.png");
